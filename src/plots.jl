...
## Upstream kept these behind a Plots package extension; in this fork Plots is a
## hard, reexported dependency, so the implementations live here directly.
...
adapted_grid = PlotUtils.adapted_grid
